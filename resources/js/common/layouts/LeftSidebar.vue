<template>
	<a-layout-sider :width="240" :style="{
		...
		paddingTop: '8px',
		zIndex: 998,
	}" :trigger="null" :collapsed="collapsed" :theme="appSetting.left_sidebar_theme" class="sidebar-right-border">
		...
		<div class="main-sidebar">
			<perfect-scrollbar :options="{
				...
				<a-menu :theme="appSetting.left_sidebar_theme" :openKeys="openKeys" v-model:selectedKeys="selectedKeys"
					:mode="mode" @openChange="onOpenChange" :style="{ borderRight: 'none' }">
					<a-menu-item @click="
						() => {
							menuSelected();
					...
					" @click="
						...
						<span>{{ $t("menu.pos") }}</span> (Point Of Sales)
					</a-menu-item>
					...
					<a-sub-menu key="product_manager" v-if="
					...
					<!-- <a-menu-item @click="menuSelected" key="online_orders" v-if="
					...
					" key="website_setup">
						...
						<a-menu-item v-if="
							permsArray.includes('product_cards_view') ||
							permsArray.includes('admin')
						" @click="menuSelected" key="product_cards">
							<router-link :to="{
						...
						<a-menu-item v-if="
							...
							permsArray.includes('admin')
						" @click="menuSelected" key="front_settings">
							<router-link :to="{
